    ...
    -> std::size_t
  {
    ...
    else if (n > 1 && ((c8[0] & 0b1110'0000) == 0b1100'0000))
    {
      if ((c8[1] & 0b1100'0000) == 0b1000'0000)
      {
        if (c32 != nullptr)
        {
          auto t = (c8[0] & 0b0001'1111) << 6 | (c8[1] & 0b0011'1111);
          if (t < 0x80 || 0x7ff < t)
            return 0;
          *c32 = t;
          r = 2;
    ...
    else if (n > 1 && (c8[0] & 0b1111'0000) == 0b1110'0000)
    {
      if (((c8[1] & 0b1100'0000) == 0b1000'0000) && ((c8[2] & 0b1100'0000) == 0b1000'0000))
      {
        if (c32 != nullptr)
        {
          auto t = (c8[0] & 0b0000'1111) << 12 | (c8[1] & 0b0011'1111) << 6 | (c8[2] & 0b0011'1111);
          if (t < 0x800 || 0xffff < t)
            return 0;
          *c32 = t;
          r = 3;
    ...
    else if (n > 2 && (c8[0] & 0b1111'1000) == 0b1111'0000)
    {
      if (((c8[1] & 0b1100'0000) == 0b1000'0000) && ((c8[2] & 0b1100'0000) == 0b1000'0000) && ((c8[3] & 0b1100'0000) == 0b1000'0000))
      {
        if (c32 != nullptr)
        {
          auto t = (c8[0] & 0b0000'1111) << 18 | (c8[1] & 0b0011'1111) << 12 | (c8[2] & 0b0011'1111) << 6 | (c8[3] & 0b0011'1111);
          if (t < 0x10000 || 0x0010ffff < t)
            return 0;
          *c32 = t;
          r = 4;
        }
