...
namespace menon
{
  namespace detail
  {
    constexpr char const* encoding_list[] =
    {
      "ANSI_X3.4-1968", 
      "ANSI_X3.4-1986", 
      "ASCII", 
    ...
    constexpr auto find_encoding_key(char const* encoding)
    {
      if (encoding == nullptr)
        return -1;

      int r = 0;
      for (auto item : encoding_list)
      {
        if (std::string_view(item) == encoding)
          return r;
        ++r;
      }
      return -1;
...
#endif  // !MENON_BITS_ENCODONG_LIST_HH_
